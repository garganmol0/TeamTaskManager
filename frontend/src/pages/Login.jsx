...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-6 selection:bg-indigo-500/30 selection:text-indigo-200 relative">
      <div className="absolute top-1/4 left-1/3 w-72 h-72 bg-indigo-500/5 rounded-full blur-[100px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800/90 p-8 rounded-2xl shadow-2xl z-10">
        <div className="flex flex-col items-center gap-3 mb-8">
          ...
          <h2 className="text-2xl font-extrabold text-white tracking-tight">Sign in to TaskForge</h2>
          <p className="text-xs text-slate-400 font-medium">Enter your credentials to access your workspace</p>
        </div>
